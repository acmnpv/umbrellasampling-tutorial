...
\usetheme[hideothersubsections,withnav]{Berkeley}
...
\frametitle{Sampling problems in Molecular Dynamics}
    \begin{figure}[htb]
        \centering
        \includegraphics[keepaspectratio=true, width=0.8\textwidth]{figures/system.pdf}
...
\frametitle{Example visualization of US windows}
    \begin{figure}[htb]
        \centering
        \includegraphics[keepaspectratio=true, width=0.8\textwidth]{figures/pyrimidine-us.pdf}
